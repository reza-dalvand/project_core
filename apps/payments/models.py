...
from apps.core.utils import generate_ref_number, generate_tracking_code
...
class Transaction(BaseModel):
    ...
    app_fee = models.BigIntegerField(
        "کمیسیون بیو کلاب (تومان)",
        default=0,
    )
    ...
    estimated_settlement = models.DateTimeField(
        "تاریخ تخمینی تسویه",
        null=True,
        blank=True,
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            # ✅ فاز ۵: ایندکس‌های جدید برای فیلترهای رایج
            models.Index(
